			...
			<div class="diary-wrapper">
				...
				<?php 
					...
					if (getCurrentScore() >= 150000) {
						if (getPuzzleUnlockStatus('final_puzzle')) {
							echo '<h1 style="text-transform: uppercase;" class="diary-sub">The Grail</h1><div onclick="Grail.open(\'final_puzzle\')" class="diary-item part-solved"><h3 class="diary-item-title">Final Puzzle</h3><div class="score-awarded">'.getPuzzleScore('final_puzzle').'</div><img draggable="false" class="lock-icon" src="/assets/img/unlocked.png"></div>';
						} else {
